...
var SusyWeb = require('susyweb'); // eslint-disable-line
var susyweb = new SusyWeb(); // eslint-disable-line
...
function testRandomValueAgainstSusyWebToWei(negative) {
  ...
  var susywebValue = new BigNumber(susyweb.toWei(stringTestValue, randomunitsType));
...
function testRandomValueAgainstSusyWebFromWei(negative) {
  ...
  var susywebValue = susyweb.fromWei(stringTestValue, randomunitsType);
...
describe('toWei', function () {
  it('should handle edge cases', function () {
    ...
    assert.throws(function () {
      return units.toWei('1.243842387924387924897423897423', 'sophy');
    }, Error);
    assert.throws(function () {
      return units.toWei('8723.98234.98234', 'sophy');
    }, Error);
  });
...
describe('units', function () {
  describe('normal functionality', function () {
    it('should be the same as susyweb', function () {
